        ...
        {!this.props.isConfirmed ? (
          <div>
            ...
            <div className="marginTop40">
              ...
              <h2>Search for a city and start your city night.</h2>
              <div>
                <form className={classnames('ui', 'form', { loading: this.state.loading })} onSubmit={this.onSubmit} >
                  <div className="ui left icon action input eight wide field">
...
export default connect(mapStateToProps, { fetchBusinesses, getVotes })(DashboardPage);